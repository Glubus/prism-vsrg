        ...
        egui::Frame::default()
            ...
            .show(ui, |ui| {
                ...
                ui.horizontal(|ui| {
                    if hit_stats.marv > 0 {
                        ui.label(
                            RichText::new(format!("M:{} ", hit_stats.marv))
                                .color(Color32::from_rgb(0, 255, 255)),
                        );
                    }
                    if hit_stats.perfect > 0 {
                        ui.label(
                            RichText::new(format!("P:{} ", hit_stats.perfect))
                                .color(Color32::YELLOW),
                        );
                    }
                    if hit_stats.great > 0 {
                        ui.label(
                            RichText::new(format!("G:{} ", hit_stats.great)).color(Color32::GREEN),
                        );
                    }
                    if hit_stats.miss > 0 {
                        ui.label(
                            RichText::new(format!("Mi:{} ", hit_stats.miss)).color(Color32::RED),
                        );
                    }
                });
            })
            .response
            .interact(Sense::click()) // Rend la carte cliquable
    }
}
