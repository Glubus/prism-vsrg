...
impl MapListComponent {
    pub fn new(screen_width: f32, screen_height: f32) -> Self {
        ...
        let card_height = 80.0; // Partie entête (titre / artiste)
    ...
    pub fn create_quads(&self) -> Vec<QuadInstance> {
        ...
        // Calculer la hauteur totale du panel (hauteurs dynamiques)
        ...
        let total_height = cards_height + spacing_total + 40.0; // Padding
