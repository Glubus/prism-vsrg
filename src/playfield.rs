use crate::engine::{PixelSystem, PlayfieldConfig, NUM_COLUMNS, InstanceRaw, HIT_LINE_Y, VISIBLE_DISTANCE, NoteData};
...
impl Playfield {
    ...
    pub fn renderer(
        ...
        let note_width_norm = pixel_system.pixels_to_normalized(self.config.note_width_pixels);
        let note_height_norm = pixel_system.pixels_to_normalized(self.config.note_height_pixels);
